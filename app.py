...
def render_reprio_summary_stats(out_df: pd.DataFrame):
    ...
    for p in ["Gating", "High", "Medium", "Low"]:
        ...
        rows_html += (
            ...
            f'<td style="padding:8px 14px;text-align:center;font-family:monospace;color:#A0B0CC">{cur_count}</td>'
            f'<td style="padding:8px 14px;text-align:center;font-family:monospace;color:#E8EEFF;font-weight:600">{stp_count}</td>'
            f'<td style="padding:8px 14px;text-align:center">{delta_html}</td>'
            f'</tr>'
        )
 
    st.markdown(
        f'<table style="width:100%;border-collapse:collapse;background:#0D1321;'
        f'border:1px solid #1E2761;border-radius:8px;overflow:hidden">'
        f'<thead><tr style="border-bottom:1px solid #1E2761">'
        f'<th style="padding:8px 14px;text-align:left;font-family:monospace;font-size:0.65rem;color:#4A5A7A;letter-spacing:0.1em;text-transform:uppercase">Priority</th>'
        f'<th style="padding:8px 14px;text-align:center;font-family:monospace;font-size:0.65rem;color:#4A5A7A;letter-spacing:0.1em;text-transform:uppercase">Mevcut</th>'
        f'<th style="padding:8px 14px;text-align:center;font-family:monospace;font-size:0.65rem;color:#4FC3F7;letter-spacing:0.1em;text-transform:uppercase">STP</th>'
        f'<th style="padding:8px 14px;text-align:center;font-family:monospace;font-size:0.65rem;color:#4A5A7A;letter-spacing:0.1em;text-transform:uppercase">Fark</th>'
        f'</tr></thead>'
